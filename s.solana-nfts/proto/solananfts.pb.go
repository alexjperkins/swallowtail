...
const (
	SolanaNFTVendor_SOLANART   SolanaNFTVendor = 0
...
type ReadSolanaPriceStatisticsByCollectionIDRequest struct {
	...
	// If empty then we retrieve all vendors.
	FilterByVendors []SolanaNFTVendor      `protobuf:"varint,2,rep,packed,name=filter_by_vendors,json=filterByVendors,proto3,enum=SolanaNFTVendor" json:"filter_by_vendors,omitempty"`
...
func (x *ReadSolanaPriceStatisticsByCollectionIDRequest) GetFilterByVendors() []SolanaNFTVendor {
	if x != nil {
		return x.FilterByVendors
	}
	return nil
}
...
type VendorPriceStatistics struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Vendor SolanaNFTVendor   `protobuf:"varint,1,opt,name=vendor,proto3,enum=SolanaNFTVendor" json:"vendor,omitempty"`
	Stats  []*PriceStatistic `protobuf:"bytes,2,rep,name=stats,proto3" json:"stats,omitempty"`
}

func (x *VendorPriceStatistics) Reset() {
	*x = VendorPriceStatistics{}
	if protoimpl.UnsafeEnabled {
...
func (x *VendorPriceStatistics) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VendorPriceStatistics) ProtoMessage() {}

func (x *VendorPriceStatistics) ProtoReflect() protoreflect.Message {
	mi := &file_s_solana_nfts_proto_solananfts_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VendorPriceStatistics.ProtoReflect.Descriptor instead.
func (*VendorPriceStatistics) Descriptor() ([]byte, []int) {
	return file_s_solana_nfts_proto_solananfts_proto_rawDescGZIP(), []int{2}
}

func (x *VendorPriceStatistics) GetVendor() SolanaNFTVendor {
	if x != nil {
		return x.Vendor
	}
	return SolanaNFTVendor_SOLANART
}

func (x *VendorPriceStatistics) GetStats() []*PriceStatistic {
	if x != nil {
		return x.Stats
	}
	return nil
...
type ReadSolanaPriceStatisticsByCollectionIDResponse struct {
	...
	VendorStats []*VendorPriceStatistics `protobuf:"bytes,1,rep,name=vendor_stats,json=vendorStats,proto3" json:"vendor_stats,omitempty"`
}

func (x *ReadSolanaPriceStatisticsByCollectionIDResponse) Reset() {
	*x = ReadSolanaPriceStatisticsByCollectionIDResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_s_solana_nfts_proto_solananfts_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ReadSolanaPriceStatisticsByCollectionIDResponse) Descriptor() ([]byte, []int) {
	return file_s_solana_nfts_proto_solananfts_proto_rawDescGZIP(), []int{3}
}

func (x *ReadSolanaPriceStatisticsByCollectionIDResponse) GetVendorStats() []*VendorPriceStatistics {
	if x != nil {
...
var file_s_solana_nfts_proto_solananfts_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xff, 0x01, 0x0a, 0x2e, 0x52, 0x65, 0x61, 0x64, 0x53,
	...
	,
	...
	0x65, 0x12, 0x26, 0x0a, 0x0f, 0x6c, 0x61, 0x73, 0x74, 0x5f, 0x73, 0x6f, 0x6c, 0x64, 0x5f, 0x70,
	0x72, 0x69, 0x63, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0d, 0x6c, 0x61, 0x73, 0x74,
	0x53, 0x6f, 0x6c, 0x64, 0x50, 0x72, 0x69, 0x63, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x61, 0x74, 0x74,
	...
	,
...
var file_s_solana_nfts_proto_solananfts_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_s_solana_nfts_proto_solananfts_proto_goTypes = []interface{}{
	...
	(*VendorPriceStatistics)(nil),                           // 4: VendorPriceStatistics
	(*ReadSolanaPriceStatisticsByCollectionIDResponse)(nil), // 5: ReadSolanaPriceStatisticsByCollectionIDResponse
}
var file_s_solana_nfts_proto_solananfts_proto_depIdxs = []int32{
	1, // 0: ReadSolanaPriceStatisticsByCollectionIDRequest.filter_by_vendors:type_name -> SolanaNFTVendor
	0, // 1: ReadSolanaPriceStatisticsByCollectionIDRequest.order:type_name -> SolanaNFTSortDirection
	1, // 2: VendorPriceStatistics.vendor:type_name -> SolanaNFTVendor
	3, // 3: VendorPriceStatistics.stats:type_name -> PriceStatistic
	4, // 4: ReadSolanaPriceStatisticsByCollectionIDResponse.vendor_stats:type_name -> VendorPriceStatistics
	2, // 5: solananfts.ReadSolanaPriceStatisticsByCollectionID:input_type -> ReadSolanaPriceStatisticsByCollectionIDRequest
	5, // 6: solananfts.ReadSolanaPriceStatisticsByCollectionID:output_type -> ReadSolanaPriceStatisticsByCollectionIDResponse
...
func file_s_solana_nfts_proto_solananfts_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_s_solana_nfts_proto_solananfts_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VendorPriceStatistics); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_s_solana_nfts_proto_solananfts_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
