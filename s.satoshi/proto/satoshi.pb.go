...
type PollTradeParticipantsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PollTradeParticipantsRequest) Reset() {
	*x = PollTradeParticipantsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *PollTradeParticipantsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PollTradeParticipantsRequest) ProtoMessage() {}

func (x *PollTradeParticipantsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_s_satoshi_proto_satoshi_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PollTradeParticipantsRequest.ProtoReflect.Descriptor instead.
func (*PollTradeParticipantsRequest) Descriptor() ([]byte, []int) {
	return file_s_satoshi_proto_satoshi_proto_rawDescGZIP(), []int{2}
}

func (x *PollTradeParticipantsRequest) GetActorId() string {
	if x != nil {
		return x.ActorId
	}
	return ""
...
func (x *PollTradeParticipantsRequest) GetMessageId() string {
	if x != nil {
		return x.MessageId
	}
	return ""
...
func (x *PollTradeParticipantsRequest) GetTimeoutInMinutes() int64 {
	if x != nil {
...
func (x *PollTradeParticipantsRequest) GetTradeId() string {
	if x != nil {
		return x.TradeId
	}
	return ""
...
func (x *PollTradeParticipantsRequest) GetChannelId() string {
	if x != nil {
		return x.ChannelId
	}
	return ""
...
type PollTradeParticipantsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *PollTradeParticipantsResponse) Reset() {
	*x = PollTradeParticipantsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *PollTradeParticipantsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PollTradeParticipantsResponse) ProtoMessage() {}

func (x *PollTradeParticipantsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_s_satoshi_proto_satoshi_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PollTradeParticipantsResponse.ProtoReflect.Descriptor instead.
func (*PollTradeParticipantsResponse) Descriptor() ([]byte, []int) {
...
var file_s_satoshi_proto_satoshi_proto_rawDesc = []byte{
	...
	0x22, 0xc0, 0x01, 0x0a, 0x1c, 0x50, 0x6f, 0x6c, 0x6c, 0x54, 0x72, 0x61, 0x64, 0x65, 0x50, 0x61,
	...
	,
...
var file_s_satoshi_proto_satoshi_proto_goTypes = []interface{}{
	...
	(*PollTradeParticipantsRequest)(nil),  // 2: PollTradeParticipantsRequest
	(*PollTradeParticipantsResponse)(nil), // 3: PollTradeParticipantsResponse
}
var file_s_satoshi_proto_satoshi_proto_depIdxs = []int32{
	0, // 0: satoshi.PublishStatus:input_type -> PublishStatusRequest
	2, // 1: satoshi.PollTradeParticipants:input_type -> PollTradeParticipantsRequest
	1, // 2: satoshi.PublishStatus:output_type -> PublishStatusResponse
	3, // 3: satoshi.PollTradeParticipants:output_type -> PollTradeParticipantsResponse
...
func file_s_satoshi_proto_satoshi_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_s_satoshi_proto_satoshi_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PollTradeParticipantsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_s_satoshi_proto_satoshi_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PollTradeParticipantsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
