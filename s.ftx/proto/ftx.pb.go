...
func (x *ExecuteNewOrderRequest) GetOrder() *proto1.Order {
	if x != nil {
		return x.Order
	}
	return nil
...
func (x *ExecuteNewOrderRequest) GetCredentials() *proto1.VenueCredentials {
	if x != nil {
...
func (x *ExecuteNewOrderResponse) GetOrder() *proto1.Order {
	if x != nil {
		return x.Order
	}
	return nil
...
var file_s_ftx_proto_ftx_proto_rawDesc = []byte{
	...
	0x75, 0x6f, 0x74, 0x65, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x2a, 0x2f, 0x0a, 0x08,
	...
	0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x4d, 0x4f, 0x56, 0x45, 0x10, 0x03, 0x32, 0x82, 0x03, 0x0a,
	...
	0x00, 0x42, 0x22, 0x5a, 0x20, 0x73, 0x77, 0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x74, 0x61, 0x69, 0x6c,
	0x2f, 0x73, 0x2e, 0x66, 0x74, 0x78, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x3b, 0x66, 0x74, 0x78,
...
var file_s_ftx_proto_ftx_proto_depIdxs = []int32{
	...
	19, // 7: ExecuteNewOrderRequest.order:type_name -> Order
	18, // 8: ExecuteNewOrderRequest.timestamp:type_name -> google.protobuf.Timestamp
	20, // 9: ExecuteNewOrderRequest.credentials:type_name -> VenueCredentials
	19, // 10: ExecuteNewOrderResponse.order:type_name -> Order
	...
	13, // 16: ftx.ExecuteNewOrder:input_type -> ExecuteNewOrderRequest
	...
	14, // 21: ftx.ExecuteNewOrder:output_type -> ExecuteNewOrderResponse
